          ...
          <div class="card my-10">
            <div class="card-header p-0 position-relative mt-n4 mx-8 z-index-0">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-1 pb-3">
                <h6 class="text-white text-capitalize text-center ps-2">Add your Product</h6>
              </div>
            </div>
            <div class="card-body px-0 pb-6">
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                <form action="Bakerynotification.php" class="btn bg-gradient-primary" method="post" enctype="multipart/form-data">
